...
export const setOrigErrors = createAction('setOrigErrors', (value: Errors | null) => ({payload: value}));
export const setAddedErrors = createAction('setAddedErrors', (value: Errors | null) => ({payload: value}));
...
export const setCompareErrors = createAction('setCompareErrors', (value: Errors | null) => ({payload: value}));
